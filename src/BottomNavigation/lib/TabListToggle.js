...
import {BAR_HEIGHT_IOS} from './BottomNavigationToggle'

const iosFab = require('./iosFab/iOS_Fab.png')
...
export default class TabList extends React.PureComponent {
    static propTypes = {
        ...
        renderIconToggle: PropTypes.func
    }
    ...
    render() {
        const { tabs, renderTab, renderIconToggle } = this.props

        return (
            <View style={styles.tabs}>
                <View style={[styles.tabs, {backgroundColor: this.getActiveTab().barColor || 'transparent'}, styles.shadow]}>
                    {tabs.map((tab, i) => (
                        <TouchableWithoutFeedback
                            key={tab.key}
                ...
                <View style={styles.iosFabContainer}>
                    {renderIconToggle()}
                    <Image source={iosFab} />
                    <View style={[styles.bottomBlock, {backgroundColor: this.getActiveTab().barColor || 'transparent'}]} />
                </View>
                <View style={[styles.rightBlock, {
                    backgroundColor: this.getActiveTab().barColor || 'transparent',
                    shadowColor: '#000',
