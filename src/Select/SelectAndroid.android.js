...
var selectStyleType = StyleSheetPropType({
...
class SelectAndroid extends React.Component<{
    ...
    render() {
        ...
        var Select = this.props.mode === MODE_DROPDOWN ? DropdownPicker : DialogPicker;
...
var DropdownPicker = requireNativeComponent('AndroidDropdownPicker', SelectAndroid, cfg);

var DialogPicker = requireNativeComponent('AndroidDialogPicker', SelectAndroid, cfg);



module.exports = SelectAndroid;
